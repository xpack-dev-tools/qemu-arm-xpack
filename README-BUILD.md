...
$ ls -l ~/Work/qemu-arm-*/deploy
total 16856
-rw-rw-r-- 1 ilg ilg 8777442 Oct 14 18:58 xpack-qemu-arm-6.2.0-1-linux-arm64.tar.gz
-rw-rw-r-- 1 ilg ilg     109 Oct 14 18:58 xpack-qemu-arm-6.2.0-1-linux-arm64.tar.gz.sha
-rw-rw-r-- 1 ilg ilg 8472838 Oct 14 19:22 xpack-qemu-arm-6.2.0-1-linux-arm.tar.gz
-rw-rw-r-- 1 ilg ilg     107 Oct 14 19:22 xpack-qemu-arm-6.2.0-1-linux-arm.tar.gz.sha
```
...
$ ls -l ~/Work/qemu-arm-*/deploy
total 15120
-rw-r--r--  1 ilg  staff  7735782 Oct 14 20:24 xpack-qemu-arm-6.2.0-1-darwin-x64.tar.gz
-rw-r--r--  1 ilg  staff      108 Oct 14 20:24 xpack-qemu-arm-6.2.0-1-darwin-x64.tar.gz.sha
```
...
```console
Source path       /Host/Work/qemu-arm-6.2.0-1/qemu.git
C compiler        gcc
Host C compiler   cc
C++ compiler      g++
...
QEMU_CFLAGS       -I/Host/Work/qemu-arm-6.2.0-1/install/centos64/include/pixman-1 -I$(SRC_PATH)/dtc/libfdt -pthread -I/Host/Work/qemu-arm-6.2.0-1/install/centos64/include/glib-2.0 -I/Host/Work/qemu-arm-6.2.0-1/install/centos64/lib/glib-2.0/include -fPIE -DPIE -m64 -mcx16 -D_GNU_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Wstrict-prototypes -Wredundant-decls -Wall -Wundef -Wwrite-strings -Wmissing-prototypes -fno-strict-aliasing -fno-common -fwrapv  -ffunction-sections -fdata-sections -m64 -pipe -O2 -Wno-format-truncation -Wno-incompatible-pointer-types -Wno-unused-function -Wno-unused-but-set-variable -Wno-unused-result -I/Host/Work/qemu-arm-6.2.0-1/install/centos64/include -Wendif-labels -Wno-shift-negative-value -Wmissing-include-dirs -Wempty-body -Wnested-externs -Wformat-security -Wformat-y2k -Winit-self -Wignored-qualifiers -Wold-style-declaration -Wold-style-definition -Wtype-limits -fstack-protector-strong
LDFLAGS           -Wl,--warn-common -Wl,-z,relro -Wl,-z,now -pie -m64 -g -L/Host/Work/qemu-arm-6.2.0-1/install/centos64/lib -L/Host/Work/qemu-arm-6.2.0-1/install/centos64/lib
make              make
install           install
python            python -B
module support    no
...
```console
$ .../xpack-qemu-arm-6.2.0-1/bin/qemu-system-gnuarmeclipse --version
xPack 64-bit QEMU emulator version 6.2.0-1 (v6.2.0-12-dirty)
...
```console
$ tree -L 2 /Users/ilg/Library/xPacks/@xpack-dev-tools/qemu-arm/6.2.0-1.1/.content
/Users/ilg/Library/xPacks/@xpack-dev-tools/qemu-arm/6.2.0-1.1/.content
├── README.md
├── bin
