...
Version **2.2.92-20150404*-dev** is the initial release of the **GNU ARM Eclipse QEMU**. It is mainly a technology preview (most of the supported boards are present, but functionality is limited and only projects created with the generic Cortex-M3 template are supported).
