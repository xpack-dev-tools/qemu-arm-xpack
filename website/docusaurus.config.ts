...
const config: Config = {
  title: 'xPack QEMU Arm',
  tagline: 'A binary distribution of QEMU Arm',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/xpack-dev-tools/qemu-arm-xpack/edit/xpack/website/',
        ...
        sitemap: {
          ...
          priority: 0.5,
          ignorePatterns: [
            '/qemu-arm-xpack/blog/archive/**',
            '/qemu-arm-xpack/blog/authors/**',
            '/qemu-arm-xpack/blog/tags/**'
          ],
  ...
  themeConfig: {
    ...
    metadata: [
      {
        name: 'keywords',
        content: 'xpack, binary, development, tools, reproducibility, qemu-arm'
      }
    ],
    navbar: {
      ...
      items: [
        ...
        },
        {
          ...
          position: 'right',
          href: `https://github.com/xpack-dev-tools/qemu-arm-xpack/releases/tag/v${customFields.xpackVersion}`,
        },
        {
          ...
          items: [
            {
              ...
              href: 'https://github.com/xpack-dev-tools/qemu-arm-xpack/discussions',
            },
            {
