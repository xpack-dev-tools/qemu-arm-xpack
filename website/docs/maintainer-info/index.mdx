...
title: Information for xPack QEMU Arm maintainers
...
```sh
bash ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-travis-macos.sh
```
...
- <code>npm dist-tag ls @xpack-dev-tools/qemu-arm</code>
- <code>npm dist-tag add @xpack-dev-tools/qemu-arm@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') } latest</code>
- <code>npm dist-tag ls @xpack-dev-tools/qemu-arm</code>

In case the previous version is not functional and needs to be unpublished:

- <code>npm unpublish @xpack-dev-tools/qemu-arm@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') }</code>
...
- the result is in https://xpack-dev-tools.github.io/qemu-arm-xpack/blog/
