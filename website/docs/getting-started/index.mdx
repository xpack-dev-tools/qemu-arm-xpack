...
title: Getting Started with xPack QEMU Arm
...
**xPack QEMU Arm** is a standalone
cross-platform (Windows, macOS, GNU/Linux)binary distribution of QEMU Arm,
...
[`qemu-arm-xpack.git/build-assets/scripts`](https://github.com/xpack-dev-tools/qemu-arm-xpack/tree/xpack/build-assets/scripts/)
...
- **Star** the project on [GitHub](https://github.com/xpack-dev-tools/qemu-arm-xpack/): It helps others discover our work.
