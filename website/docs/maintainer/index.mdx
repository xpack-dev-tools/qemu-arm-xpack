...
named like **xPack QEMU Arm v{customField('upstreamVersion')}-{customField('xpackSubversion')}** (mind the dash),
...
npm dist-tag add @xpack-dev-tools/qemu-arm@${customField('upstreamVersion')}-${customField('xpackSubversion')}.${customField('npmSubversion')} latest
npm dist-tag ls @xpack-dev-tools/qemu-arm
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`npm unpublish @xpack-dev-tools/qemu-arm@${customField('upstreamVersion')}-${customField('xpackSubversion')}.${customField('npmSubversion')}
`} </CodeBlock>
...
- paste the release name like _**xPack QEMU Arm v{customField('upstreamVersion')}-{customField('xpackSubversion')} released**_
