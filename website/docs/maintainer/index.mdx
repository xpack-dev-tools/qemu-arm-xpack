...
```sh
rm -f ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets/package-lock.json
git -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git pull

xpm run install -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets

git -C ~/Work/xpack-dev-tools/xbb-helper-xpack.git pull
xpm link -C ~/Work/xpack-dev-tools/xbb-helper-xpack.git

xpm run link-deps -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets

xpm run deep-clean --config darwin-x64  -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets && \
xpm install --config darwin-x64 -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets && \
xpm run build-development --config darwin-x64 -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
```

For a debug build:

```sh
xpm run build-development-debug --config darwin-x64 -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
```
...
```sh
xpm run check-space -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
```
...
```sh
xpm run clear-all-projects-builds -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
```
...
```sh
xpm run generate-workflows -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
```
...
```sh
xpm run trigger-workflow-build-darwin-x64 -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
xpm run trigger-workflow-build-darwin-arm64 -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
xpm run trigger-workflow-build-linux-x64 -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
xpm run trigger-workflow-build-win32-x64 -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
xpm run trigger-workflow-build-linux-arm64 -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
xpm run trigger-workflow-build-linux-arm -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
```
...
[GitHub Actions](https://github.com/xpack-dev-tools/qemu-arm-xpack/actions) page.
...
```sh
xpm run trigger-workflow-test-prime -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
xpm run trigger-workflow-test-docker-linux-x64 -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
xpm run trigger-workflow-test-docker-linux-arm -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
```
...
```sh
xpm run trigger-travis-macos -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
```
...
git -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git pull
xpm run install -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
xpm run test-pre-release -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
```
...
```sh
xpm run trigger-workflow-publish-release -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
```
...
watching the qemu-arm-xpack project.
...
```sh
xpm run generate-website-blog-post -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
```
...
```sh
xpm run update-package-binaries -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
```
...
<a href="https://www.npmjs.com/package/@xpack-dev-tools/qemu-arm?activeTab=versions">npmjs.com</a>.
...
```sh
xpm run trigger-workflow-test-xpm -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
```
...
in https://xpack-dev-tools.github.io/qemu-arm-xpack/blog/
- remember the post URL, since it must be used to update the release page
and the X/Twitter announcement
- switch to https://xpack-dev-tools.github.io/qemu-arm-xpack/docs/maintainer/#update-the-xpack-branch
...
```sh
xpm run trigger-workflow-deep-clean -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
```
...
- paste the release name like _**xPack QEMU Arm v8.2.6-1 released**_
- paste the link to the blog post
  [release](https://github.com/xpack-dev-tools/qemu-arm-xpack/releases)
...
[![npm (scoped)](https://img.shields.io/npm/v/@xpack-dev-tools/qemu-arm)](https://www.npmjs.com/package/@xpack-dev-tools/qemu-arm/)
[![npm](https://img.shields.io/npm/dm/@xpack-dev-tools/qemu-arm)](https://www.npmjs.com/package/@xpack-dev-tools/qemu-arm/)
  - all releases [![npm](https://img.shields.io/npm/dt/@xpack-dev-tools/qemu-arm)](https://www.npmjs.com/package/@xpack-dev-tools/qemu-arm/)
