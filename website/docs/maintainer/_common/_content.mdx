...
```sh
npm run generate-top-commons -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git
```
...
- open https://xpack-dev-tools.github.io/qemu-arm-xpack/docs/maintainer/#publish-the-website in a separate window
...
[![NPM Version](https://img.shields.io/npm/v/%40xpack-dev-tools%2Fqemu-arm?color=green)](https://www.npmjs.com/package/@xpack-dev-tools/qemu-arm/)
[![NPM Downloads](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Fqemu-arm)](https://www.npmjs.com/package/@xpack-dev-tools/qemu-arm/)
  - all releases [![NPM Downloads](https://img.shields.io/npm/dt/%40xpack-dev-tools%2Fqemu-arm)](https://www.npmjs.com/package/@xpack-dev-tools/qemu-arm/)
