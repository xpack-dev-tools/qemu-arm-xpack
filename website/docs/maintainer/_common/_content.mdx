...
**@xpack-dev-tools/qemu-arm** is an xpm package that packages platform-specific archives, built with the [xPack Build Box (XBB)](https://xpack.github.io/xpack-build-box/).
...
```sh
rm -rf ~/Work/xpack-dev-tools/qemu-arm-xpack.git/package-lock.json
```
...
npm --prefix ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets install
xpm install -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
...
xpm run trigger-workflow-test-docker-linux-arm64 -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
```
...
named such as **xPack QEMU Arm v9.2.4-1** (mind the dash),
...
- Navigate to the [GitHub Releases](https://github.com/xpack-dev-tools/qemu-arm-xpack/releases) page
...
npm --prefix ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets install && \
xpm install -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets && \
xpm run test-release -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/build-assets
```
