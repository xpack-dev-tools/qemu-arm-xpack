...
The command to install the **latest** available version of **qemu-arm** is:
...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/qemu-arm@${customField('releaseVersion')} --verbose
`} </CodeBlock>
...
In order to access the QEMU Arm binaries installed in
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/qemu-arm/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/qemu-arm/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/qemu-arm/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-qemu-arm-{customField('xpackVersion')}-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\qemu-arm\\xpack-qemu-arm-{customField('xpackVersion')}</code>.
...
<ul>
<li><code>xpack-qemu-arm-{customField('xpackVersion')}-darwin-x64.tar.gz</code></li>
<li><code>xpack-qemu-arm-{customField('xpackVersion')}-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/qemu-arm/xpack-qemu-arm-{customField('xpackVersion')}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/qemu-arm
cd ~/Library/xPacks/qemu-arm

tar xvf ~/Downloads/xpack-qemu-arm-${customField('xpackVersion')}-darwin-x64.tar.gz
chmod -R -w xpack-qemu-arm-${customField('xpackVersion')}
`} </CodeBlock>
...
<ul>
<li><code>xpack-qemu-arm-{customField('xpackVersion')}-linux-x64.tar.gz</code></li>
<li><code>xpack-qemu-arm-{customField('xpackVersion')}-linux-arm64.tar.gz</code></li>
<li><code>xpack-qemu-arm-{customField('xpackVersion')}-linux-arm.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/qemu-arm/xpack-qemu-arm-{customField('xpackVersion')}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/qemu-arm
cd ~/.local/xPacks/qemu-arm

tar xvf ~/Downloads/xpack-qemu-arm-${customField('xpackVersion')}-linux-x64.tar.gz
chmod -R -w xpack-qemu-arm-${customField('xpackVersion')}
`} </CodeBlock>
