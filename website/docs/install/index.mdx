...
The easiest (and recommended) way to install xPack QEMU Arm
...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/qemu-arm@8.2.6-1.1 --verbose
`} </CodeBlock>
...
* add <code>@xpack-dev-tools/qemu-arm</code> to
  `package.json` as a
  development dependency; this associates a specific version of xPack QEMU Arm with
...
it is also possible to install xPack QEMU Arm only globally in
...
In order to access the xPack QEMU Arm binaries installed in
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/qemu-arm/8.2.6-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/qemu-arm/8.2.6-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/qemu-arm/8.2.6-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-qemu-arm-8.2.6-1-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\qemu-arm\\xpack-qemu-arm-8.2.6-1</code>.
...
<ul>
<li><code>xpack-qemu-arm-8.2.6-1-darwin-x64.tar.gz</code></li>
<li><code>xpack-qemu-arm-8.2.6-1-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/qemu-arm/xpack-qemu-arm-8.2.6-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/qemu-arm
cd ~/Library/xPacks/qemu-arm

tar xvf ~/Downloads/xpack-qemu-arm-8.2.6-1-darwin-x64.tar.gz
chmod -R -w xpack-qemu-arm-8.2.6-1
`} </CodeBlock>
...
<ul>
<li><code>xpack-qemu-arm-8.2.6-1-linux-x64.tar.gz</code></li>
<li><code>xpack-qemu-arm-8.2.6-1-linux-arm64.tar.gz</code></li>
<li><code>xpack-qemu-arm-8.2.6-1-linux-arm.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/qemu-arm/xpack-qemu-arm-8.2.6-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/qemu-arm
cd ~/.local/xPacks/qemu-arm

tar xvf ~/Downloads/xpack-qemu-arm-8.2.6-1-linux-x64.tar.gz
chmod -R -w xpack-qemu-arm-8.2.6-1
`} </CodeBlock>
