...
- <code>xpack-qemu-arm-{customField('xpackVersion')}-win32-x64.zip</code>
...
- <code>xpack-qemu-arm-{customField('xpackVersion')}-darwin-x64.tar.gz</code>- <code>xpack-qemu-arm-{customField('xpackVersion')}-darwin-arm64.tar.gz</code>
...
- <code>xpack-qemu-arm-{customField('xpackVersion')}-linux-x64.tar.gz</code>- <code>xpack-qemu-arm-{customField('xpackVersion')}-linux-arm64.tar.gz</code>- <code>xpack-qemu-arm-{customField('xpackVersion')}-linux-arm.tar.gz</code>
