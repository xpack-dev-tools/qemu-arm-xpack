...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/xpack-dev-tools/qemu-arm/9.2.4-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/xpack-dev-tools/qemu-arm/9.2.4-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/xpack-dev-tools/qemu-arm/9.2.4-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-qemu-arm-9.2.4-1-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\qemu-arm\\xpack-qemu-arm-9.2.4-1</code>.
...
<ul>
<li><code>xpack-qemu-arm-9.2.4-1-darwin-x64.tar.gz</code></li>
<li><code>xpack-qemu-arm-9.2.4-1-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/qemu-arm/xpack-qemu-arm-9.2.4-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/qemu-arm
cd ~/Library/xPacks/qemu-arm

tar xvf ~/Downloads/xpack-qemu-arm-9.2.4-1-darwin-x64.tar.gz
chmod -R -w xpack-qemu-arm-9.2.4-1
`} </CodeBlock>
...
<ul>
<li><code>xpack-qemu-arm-9.2.4-1-linux-x64.tar.gz</code></li>
<li><code>xpack-qemu-arm-9.2.4-1-linux-arm64.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/qemu-arm/xpack-qemu-arm-9.2.4-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/qemu-arm
cd ~/.local/xPacks/qemu-arm

tar xvf ~/Downloads/xpack-qemu-arm-9.2.4-1-linux-x64.tar.gz
chmod -R -w xpack-qemu-arm-9.2.4-1
`} </CodeBlock>
