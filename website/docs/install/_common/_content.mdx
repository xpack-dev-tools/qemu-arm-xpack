...
The **xPack QEMU Arm** may be installed automatically, utilising the `xpm` command
(the recommended method), or manually, by downloading and unpacking one of the
platform-specific archives.

## Automated installation

The easiest (and recommended) method to install xPack QEMU Arm
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/xpack-dev-tools/qemu-arm/8.2.6-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/xpack-dev-tools/qemu-arm/8.2.6-1.1/.content/bin:$PATH
`} </CodeBlock>
