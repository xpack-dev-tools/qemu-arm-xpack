...
```sh
npm --prefix ~/Work/xpack-dev-tools/qemu-arm-xpack.git/tests install
xpm run deep-clean -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/tests
```
...
```sh
xpm run install -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/tests
xpm run test -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/tests
```

To execute a selection of tests with the latest versions of toolchains:

```sh
xpm run install-selected -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/tests
xpm run test-selected -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/tests
```

To execute all tests with the latest versions of toolchains:

```sh
xpm run install-latest -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/tests
xpm run test-latest -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/tests
```

To execute all tests with all toolchain versions:

```sh
xpm run install-all -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/tests
xpm run test-all -C ~/Work/xpack-dev-tools/qemu-arm-xpack.git/tests
```
